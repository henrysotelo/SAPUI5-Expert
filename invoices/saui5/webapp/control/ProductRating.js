...
sap.ui.define([
    ...
    function (Control, RatingIndicator, Label, Button) {
        ...
        return Control.extend("logaligroup.saui5.control.ProductRating", {
            ...
            init: function () {
                ...
                this.setAggregation("_label", new Label({
                    text: "{i18n>productRatingLabelInicial}"
            ...
            reset: function () {
                ...
                this.getAggregation("_label").setText(oResourceBundle.getText("productRatingLabelInicial"));
